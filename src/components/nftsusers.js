                        ...
                        <div className="container-fluid">
                            ...
                            <div className="row heading-bg">
                                <div className="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                    <h5 className="txt-dark">NFTS Users Detail</h5>
                                </div>
                                {/* <!-- Breadcrumb --> */}
                                            ...
                                            {this.state.user_list.map(item=>(
                                                            <tr>
                                                                ...
                                                                <td class="text-nowrap">
                                                                 ...
                                                                 <button type="submit" className=" btn-success" onClick={this.updateApprovedAPI.bind(this, item)} data-toggle="tooltip" data-original-title="Close"> <i class="fa fa m-r-10"></i>Approve </button> 
                                                                 </>
